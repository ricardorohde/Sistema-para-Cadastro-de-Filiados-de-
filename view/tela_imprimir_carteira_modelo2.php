 ...
 <div class="conteiner"> 
	  <div class="row">
		<div id="frente_carteira">
          ...
          <div class="topo">
          	  <img id="fundo" src="../imagens/img_carteira/fundo_azul.jpg" alt="">
          ...
          <div id="corpo">
             ...
             <p class="font-weight-bold"id="dados_frente"style="color:#000;">Matricula: <?php echo $matricula;?></p>
             <p class="font-weight-bold"id="dados_frente"style="color:#000;">Nome:  <?php echo $linhas['nome'];?></p>
             <p class="font-weight-bold"id="dados_frente"style="color:#000;">Cargo:  <?php echo $linhas['funcao'];?></p>
             <p class="font-weight-bold"id="dados_frente"style="color:#000;">Congregação:  <?php echo $linhas['congregacao'];?></p>
             <p id="endereco1"><strong>Rua Coronel Antônio Botelho, S/N.Parque Santa Fé-Maranguape-Ce</strong></p>
          </div>           	  
                           	
                  	
		 </div>
      <h4 id="cab_cartao"style="color:#000;">CARTÃO DE IDENTIFICAÇÃO</h4>
     <img id="foto_carteira"src="../imagens/<?php echo $linhas['arquivo'];?>" width="120" height="150" style="border-radius:10px;">
		...
		<div id="verso_carteira">	  	
         <img id="fundo_verso" src="../imagens/img_carteira/fundo_azul.jpg" alt="">
        <div id="corpo_verso">
                         
             <p class="font-weight-bold"id="dados_verso"style="color:#000;"><label id="tex_documento"style="color:#000;">Documento:</label>&nbsp;<?php echo $linhas['documento'];?>
              <label id="tex_nascimento">Nascimento:</label>&nbsp;
              <?php echo date("d/m/Y",strtotime($linhas['dataNascimento']));?></p>
             <p class="font-weight-bold"id="dados_verso"style="color:#000;"><label id="tex_batizado">Batizado em:&nbsp;</label><?php echo date("d/m/Y",strtotime($linhas['dataBatismo']));?>
              <label id="tex_estadocivil">Estado Civil:</label>&nbsp;<?php echo $linhas['estadoCivil'];?></p>
             <p class="font-weight-bold"id="dados_verso"style="color:#000;"><label id="tex_mae">Mãe:</label>&nbsp;<?php echo $linhas['mae'];?></p>
             <p class="font-weight-bold"id="dados_verso"style="color:#000;"><label id="tex_pai">Pai:</label>&nbsp;<?php echo $linhas['pai'];?></p>
          </div>
         ...
         enquanto proceder conforme os principios da palavra de Deus.
          ...
          <img  id="assinatura" src="../imagens/img_carteira/assinatura.png"style="color:#000;"/>  
