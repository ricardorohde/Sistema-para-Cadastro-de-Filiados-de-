 ...
 <div class="conteiner"> 
	  <div class="row">
		<div id="frente_carteira">
          ...
          <div class="topo">
          	  <img id="fundo" src="../imagens/img_carteira/diverso.png" alt="">
      ...
      <h4 id="cab_cartao">CARTÃO DE IDENTIFICAÇÃO</h4>
     <img id="foto_carteira"src="../imagens/<?php echo $linhas['arquivo'];?>" width="120" height="150" style="border-radius:10px;">
		...
		<div id="verso_carteira">	  	
         <img id="fundo_verso" src="../imagens/img_carteira/diverso.png" alt="">
        <div id="corpo_verso">
